...
function add_btn_cb() {
    document.documentElement.innerHTML += ' <div id="cb_container" style=" position: absolute; top: 0.16rem; right: 3rem; z-index: 6; "> <button style=" position: relative; padding: 0.4rem 0.8rem; white-space: nowrap; border-radius: 16px; border: none; box-shadow: 1px 1px 16px 1px #999; " id="cb">关闭伪元素 </button> <button style=" position: relative; padding: 0.4rem 0.8rem; white-space: nowrap; border-radius: 16px; border: none; box-shadow: 1px 1px 16px 1px #999; " id="oh">开启onmouseenter状态 </button> <span id="cb_close" style=" position: absolute; top: 0; left: -0.4rem; text-align: center; font-size: 0.6rem; /* transform: scale(1.6,1); */ line-height: 1rem; width: 1rem; height: 1rem;/* background-color: rgb(194, 194, 194);*/ ">x</span> </div>';
}
add_btn_cb()
...
function s_ac_pos() {
    ...
    cbc.onmouseover = function () {
        this.style.backgroundColor = 'rgba(255,70,80,.6)';
    }
    cbc.onmouseout = function () {
...
oh.onclick = function () {
    if (oh_f == 0) {
        all_mEnter();
        this.innerText = '开启onmouseleave状态';
        oh_f = 1;
    } else {
        all_mLeave();
        this.innerText = '开启onmouseenter状态';
        oh_f = 0;
    }
}
...
function all_mEnter() {
    for (var j = 0; j < lis.length; j++) {
        var es = document.body.children;
        var as = document.body.querySelectorAll('.apposition');
        // console.log(es);
        var th3 = document.body.querySelectorAll('.eq');
        var th3H = document.body.querySelectorAll('.equal_head');
        var th3B = document.body.querySelectorAll('.equal_body');
        var th5 = document.body.querySelectorAll('h5');
        var mt = document.body.querySelectorAll('.mTitle');
        var a = document.body.querySelectorAll('a');
        var links = document.body.querySelectorAll('.link');
        var lh = getEle_offset_style(document.body, 'h');
        var eg = document.body.querySelectorAll('.eg');
...
function all_mLeave() {
    ...
    var as = document.body.querySelectorAll('.apposition');
    var th3 = document.body.querySelectorAll('.eq');
    var th31 = document.body.querySelectorAll('.equ')
    var th5 = document.body.querySelectorAll('h5');
    var mt = document.body.querySelectorAll('.mTitle');
    var links = document.body.querySelectorAll('.link');
