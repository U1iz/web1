...
let paragraph_0001 = '过去的三个学期期间，我保持上课认真听讲，课下组织同学们一起学习，并通过自己的努力在最终的学业水平考取得了语数英三门全A的战果。';
let paragraph_0002 = '我积极与朋友结伴参加各种活动、比赛和社团，曾在第七届中国国际 “互联网”+大学生创新创业比赛和首届长三角人工智能挑战赛均获得了优胜奖。';
let paragraph_0003 = '我们常常结伴参加各项比赛活动以及社团，曾参加了第七届中国国际 “互联网”+专业课外方面我主要自学了HTML 5、CSS 3（及其扩展语言less和scss）和js（JavaScript）这几门主要用于web的语言。且于2021年7月正式注册了自己的域名，建立的我的网站用于记录我自己的学习笔记。每次我的笔记有所更新我都会通知同我一道学习的朋友，以便他们来复习巩固。';
let paragraph_0004 = '我相信合理的付出一定会在某个机遇下得以体现。正所谓“技多不压身”，“活到老学到老”，相信在未来的我也不会停止学习和思考，坚持做我所热爱的事，通过我自身的努力考上我心仪的本科院校。';

window.addEventListener('load', function () {
    add_title('计算机201 32 郁志良 fin0004', [
        ['label', 'h1'],
        ['fontWeight', 400],
    ...
    add_normalNode(split_p(paragraph_0004), ['p', 'normal', '0 5% 3.2% 5%', ud, ud, 'paragraph-2em'], [], [
        ['padding', '0.4rem', '1.6rem'],
        ['position', 'relative'],
        ['right', '-100%'],
        ['width', '90%'],
    ...
    add_normalNode(['Word文档 source: fin0004.docx'], ['a', 'normal', '6.4% 5% 0 5%', ud, ud, 'paragraph-2em'], [
        ['textDecoration', 'none'],
        ['color', '#999'],
        ['width', '100%'],
        ['height', '100%'],
        ['cursor', 'pointer'],
        ['fontSize', '0.4rem'],
        ['element-attribute', 'href', 'source/fin0004.docx']
    ], [
        ['padding', '0.4rem', '1.6rem'],
        ['width', '90%'],
        ['transition', 'all 0.64s'],
    ...
    add_normalNode(['pdf文档 source: fin0004.pdf'], ['a', 'normal', '0.2rem 5% 12% 5%', ud, ud, 'paragraph-2em'], [
        ['textDecoration', 'none'],
        ['width', '100%'],
        ['height', '100%'],
        ['cursor', 'pointer'],
        ['color', '#999'],
        ['fontSize', '0.4rem'],
        ['element-attribute', 'href', 'source/fin0004.pdf']
    ], [
        ['padding', '0.4rem', '1.6rem'],
        ['width', '90%'],
        ['transition', 'all 0.64s'],
