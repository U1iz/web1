...
let paragraph_0002 = '在过去的三个学期的时间里，我不仅对计算机领域有了更多的了解，也结交了一些很实在的朋友且一并走出了“中考没考上高中”的阴霾。我们常常结伴参加各项活动比赛，虽然多次比赛都与冠军有些距离，但我们各个都收获了团体合作的经验以及带来的乐趣。';
let paragraph_0003 = '在此过程中我基本摆脱了自己拖延和懒散的性格习惯，同时利用闲暇时间自学了很多专业相关和自己感兴趣的技术。';
let paragraph_0004 = '目前我能够熟练使用C4D（Cinema 4D）进行建模并调整PBR材质后使用ProRender进行渲染。';
let paragraph_0005 = '通过收集合法的网络资源，我自学了H5C3和js（JavaScript）这几门主要用于web的语言。我享受着使用js成功封装一个个功能齐全且足够严谨的函数后带来的快感，感慨着长时间debug后找到答案时的茅塞顿开，为学到了新的API而兴奋。正是因为我对web前端的热爱，我在2021年7月正式注册了属于我个人的公网ip，购买了我专属的服务器空间，拥有了属于我自己的网站用于记录我自己的学习笔记，且目前仍在更新维护中。';
let paragraph_0006 = '我对知识充满渴望，对未来抱有期待，我相信合理的付出一定会在某个机遇下得以体现。所谓“技多不压身”，“活到老学到老”，相信在未来的我也不会停止学习和思考，坚持做我所热爱的事，通过我自身的努力考上我心仪的本科院校。';
window.addEventListener('load', function () {
    add_title('计算机201 32 郁志良 初稿0001', [
        ['label', 'h1'],
        ['fontWeight', 400],
    ...
    add_normalNode(['Word文档 source: 0001.docx'], ['a', 'normal', '6.4% 5% 0 5%', ud, ud, 'paragraph-2em'], [
        ['textDecoration', 'none'],
        ['color', '#999'],
        ['width', '100%'],
        ['height', '100%'],
        ['cursor', 'pointer'],
        ['fontSize', '0.4rem'],
        ['element-attribute', 'href', 'source/0001.docx']
    ], [
        ['padding', '0.4rem', '1.6rem'],
        ['width', '90%'],
        ['transition', 'all 0.64s'],
    ...
    add_normalNode(['pdf文档 source: 0001.pdf'], ['a', 'normal', '0.2rem 5% 12% 5%', ud, ud, 'paragraph-2em'], [
        ['textDecoration', 'none'],
        ['width', '100%'],
        ['height', '100%'],
        ['cursor', 'pointer'],
        ['color', '#999'],
        ['fontSize', '0.4rem'],
        ['element-attribute', 'href', 'source/0001.pdf']
    ], [
        ['padding', '0.4rem', '1.6rem'],
        ['width', '90%'],
        ['transition', 'all 0.64s'],
